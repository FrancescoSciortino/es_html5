...
/* input commenti  CAMBIARE NOME */
    ...
    Create_article_with_modal(id_modal_text,id_modal_user,id_modal_category,id_modal_title,id_modal_check_Featured,id_modal_check_Public){
    ...
    get_array_from(url){
        ...
        var options = {url: url, success: function(data, a, b){
            ...
            for(var i = 0;i<data.length;i++){
                array_Articoli.push(transform_array(data[i]));
            }
    ...
    transform_array(backArticle){
        ...
        var articolo = new Article("ALL",titolo,testo,"<strong>Anonimo</strong>");
        articolo.tag = tags;
